...
export const PERMISSIONS = {
  ...
  VIEW_USERS: [UserRole.ADMINISTRADOR, UserRole.MECANICO, UserRole.ESPECIALISTA, UserRole.PILOTO],
  ...
  VIEW_COMPONENTS: [UserRole.ADMINISTRADOR, UserRole.MECANICO, UserRole.ESPECIALISTA, UserRole.PILOTO],
  ...
  VIEW_WORK_ORDERS: [UserRole.ADMINISTRADOR, UserRole.MECANICO, UserRole.ESPECIALISTA, UserRole.PILOTO],
  ...
  VIEW_INSPECTIONS: [UserRole.ADMINISTRADOR, UserRole.MECANICO, UserRole.ESPECIALISTA, UserRole.PILOTO],
  ...
  VIEW_INVENTORY: [UserRole.ADMINISTRADOR, UserRole.MECANICO, UserRole.ESPECIALISTA, UserRole.PILOTO],
  UPDATE_FLIGHT_HOURS: [UserRole.ADMINISTRADOR, UserRole.MECANICO, UserRole.PILOTO],
  ...
  VIEW_CATALOGS: [UserRole.ADMINISTRADOR, UserRole.MECANICO, UserRole.ESPECIALISTA, UserRole.PILOTO],
  MANAGE_CATALOGS: [UserRole.ADMINISTRADOR, UserRole.MECANICO],
  
  // Dashboards y reportes
  VIEW_DASHBOARD: [UserRole.ADMINISTRADOR, UserRole.MECANICO, UserRole.ESPECIALISTA, UserRole.PILOTO],
  VIEW_ADVANCED_REPORTS: [UserRole.ADMINISTRADOR, UserRole.MECANICO, UserRole.ESPECIALISTA],
  
  // Monitoreo de flota
  VIEW_MONITORING: [UserRole.ADMINISTRADOR, UserRole.MECANICO, UserRole.ESPECIALISTA, UserRole.PILOTO],
